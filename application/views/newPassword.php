          ...
          <div class="col-lg-12">
            <div id="user-form" >
              ...
              <div class="text-center">
                <span class="help-block btn btn-danger" style="width: 100%;"><?php echo $this->session->flashdata('msg_error'); ?>          
                </span>
              </div>
              <?php endif; ?>
              <div class="login-wrap"> 
                  ...
                  <button class="btn btn-lock pull-left" type="submit">Update Password </button>  <a href="<?php echo base_url('users/user/dashboard');?>" class="btn btn-danger skip-btn">Skip</a>
              </div>
          </div>
        </div>
      </form>             

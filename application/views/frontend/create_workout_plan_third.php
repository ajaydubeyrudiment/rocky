...
$user             = user_info();
$keys             = array();  
$planTitle        = !empty($planRow->plan_name)?$planRow->plan_name:"";
$plan_description = !empty($planRow->plan_description)?$planRow->plan_description:"";
if(empty($plan_id)){
  $thirdStep        = ' <div class="form-group">
                        <input type="text" placeholder="Plan title" name="plan_name" id="plan_name" maxlength="20" class="form-control" value="'.$planTitle.'" />
                        <div id="plan_name_error" class="text-danger"></div>
                      </div>
                      <div class="form-group">
                        <textarea name="plan_description" placeholder="Plan description" id="plan_description" rows="5" class="form-control" maxlength="200">'.$plan_description.'</textarea>
...
if(!empty($exercises)){
  ...
  foreach($exercises  as $exercis){
    ...
    echo '<div class="table-responsive create_workout" id="'.$keyID.'">  
      ...
      ?>
      <td>
        <a class="btn btn-sm btn-default" href="javascript:void(0);" onclick="addCopyExecis('<?php echo $exercisRow->id; ?>','<?php echo $keyID; ?>');" title="copy exercise"><i class="fa fa-clone"></i></a>

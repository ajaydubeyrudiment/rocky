...
?> 
  <div class="create_workout create_diet table-responsive"  id="<?php echo $keyID;?>">
    <table class="table table-bordered">   
      <tr>
        ...
        <td>
          <a class="btn btn-sm btn-primary" href="javascript:void(0);" onclick="copyFood('<?php echo $row->id; ?>','<?php echo $keyID; ?>');" title="Copy Food"><i class="fa fa-clone"></i></a>

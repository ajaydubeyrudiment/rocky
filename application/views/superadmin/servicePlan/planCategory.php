...
<section class="content-header" id="filter_main">
  <form action="" method="get">
    ...
    <div class="filter_box" style="width:">
      ...
      <input type="text" name="category_name" value="<?php if($this->input->get('category_name')){echo $this->input->get('category_name');}?>" class="form-control"  placeholder="Search Category Name">
    </div>
    <div class="filter_box" style="width:">
      <label>Order</label>
            ...
            if(!empty($rows)){
              foreach ($rows as $res_data){?>
                <tr>
                    ...
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li role="presentation">
                          <a role="menuitem" tabindex="-1" href="javascript:void(0);" onclick="changeStatus('service_plan_category','Category','<?php if(!empty($res_data->id)) echo $res_data->id; ?>','<?php echo $k; ?>','<?php if($k==1){ echo 'activate';}else if($k==3){ echo 'delete';}else{ echo 'deactive';}?>','id','status');">
                            <?php echo $status_a; ?>
                          </a>
                        </li>
                        <?php } 
                  ...
                  <td class="text-center"> 
                    <a class="btn btn-sm btn-primary" href="<?php echo ADMIN_URL.'servicePlan/addPlanCategory/';?><?php if(!empty($res_data->id)) echo $res_data->id;?>">
                        <i class="fa fa-pencil" aria-hidden="true"></i>
                     </a>   
                     <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="changeStatus('service_plan_category','Category','<?php if(!empty($res_data->id)) echo $res_data->id; ?>','3','delete','id','status');");">
                  ...
                  <tr >
                    <td colspan="7" class="text-center text-danger">
                      <span class="data-not-present">
                        <?php echo 'No category records found'; ?>                
                      </span>
                    </td>
                  </tr>              
              <?php } ?> 

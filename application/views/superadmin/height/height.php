...
<section class="content-header" id="filter_main">
  <form action="" method="get">
    <div class="filter_box" style="width:">
      <label>Height ID</label>
      <input type="text" name="Height_id" value="<?php if($this->input->get('Height_id')){echo $this->input->get('Height_id');}?>" class="form-control"  placeholder="Search Height ID">
    </div>
    <div class="filter_box" style="width:">
      <label>Order</label>
          ...
          <table class="table table-bordered">
            <tr>
              <head>
                ...
                <th class="text-center">Height ID</th> 
                <th class="text-left">Height cm</th>
                <th class="text-left">Height feet & inch</th>
            ...
            if(!empty($rows)){
              foreach ($rows as $res_data){?>
                <tr>
                  ...
                  <td class="text-left">
                    <?php  echo !empty($res_data->hieght_cm)? ucfirst($res_data->hieght_cm):'-';?>
                  </td>
                   <td class="text-left">
                    <?php  echo !empty($res_data->height_title)? ucfirst($res_data->height_title):'-';?>
                  </td>
                    ...
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li role="presentation">
                          <a role="menuitem" tabindex="-1" href="javascript:void(0);" onclick="changeStatus('height','Height','<?php if(!empty($res_data->id)) echo $res_data->id; ?>','<?php echo $k; ?>','<?php if($k==1){ echo 'activate';}else if($k==3){ echo 'delete';}else{ echo 'deactive';}?>','id','status');">
                            <?php echo $status_a; ?>
                          </a>
                        </li>
                        <?php } 
                  ...
                  <td class="text-center"> 
                    <a class="btn btn-sm btn-primary" href="<?php echo ADMIN_URL.'height/addHeight/';?><?php if(!empty($res_data->id)) echo $res_data->id;?>">
                        <i class="fa fa-pencil" aria-hidden="true"></i>
                     </a>   
                     <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="changeStatus('height','Height','<?php if(!empty($res_data->id)) echo $res_data->id; ?>','3','delete','id','status');");">
                  ...
                  <tr >
                    <td colspan="5" class="text-center text-danger">
                      <span class="data-not-present">
                        <?php echo 'No height records found'; ?>                
                      </span>
                    </td>
                  </tr>              
              <?php } ?> 
